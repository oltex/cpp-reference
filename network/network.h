...
namespace network {
	...
	inline static auto wsa_wait_for_multiple_event(unsigned long const count, HANDLE* handle, bool const wait_all, unsigned long const timeout, bool const alertable) noexcept -> unsigned long {
