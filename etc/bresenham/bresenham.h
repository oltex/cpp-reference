...
public:
	inline auto calculate(coordinate source, coordinate destination) noexcept -> library::data_structure::list<coordinate> {
		...
		library::data_structure::list<coordinate> result;
