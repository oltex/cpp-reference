...
namespace network::domain {
	inline static auto get_socket_address(wchar_t const* const node_name, wchar_t const* const service_name) noexcept -> data_structure::list<socket_address_storage> {
		data_structure::list<socket_address_storage> socket_address;
