...
namespace directx {
	...
	public:
		...
		inline explicit unorder_access_view(unorder_access_view const&) noexcept = delete;
		inline explicit unorder_access_view(unorder_access_view&&) noexcept = default;
		inline auto operator=(unorder_access_view const&) noexcept -> unorder_access_view & = delete;
