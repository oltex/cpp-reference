...
private:
	...
	public:
		inline explicit cache_set(size_t const size, size_t const mask, unsigned long shift) noexcept
...
private:
	...
	inline explicit cache_simulator(cache_simulator const& rhs) noexcept = delete;
	inline explicit cache_simulator(cache_simulator&& rhs) noexcept = delete;
	inline auto operator=(cache_simulator const& rhs) noexcept -> singleton & = delete;
	inline auto operator=(cache_simulator&& rhs) noexcept -> singleton & = delete;
