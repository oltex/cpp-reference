...
namespace utility {
	class profiler final : public library::design_pattern::singleton<profiler> {
	private:
		friend class library::design_pattern::singleton<profiler>;
	...
	private:
		library::data_structure::unordered_map<char const* const, profile> _profile;
	};
}