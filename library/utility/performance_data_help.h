...
#include "../container/unorder_map.h"
...
namespace library {
	...
	public:
		...
		inline explicit pdh_counter(void) noexcept = default;
...
#pragma warning(suppress: 6387)
		...
		inline auto add_counter(std::wstring_view const path) noexcept -> pdh_counter {
			pdh_counter counter_;
