...
namespace framework {
	client::client(void) noexcept
		...
		//resource
		{
			...
			_resources.create_resource<mesh>("rect", vertex, index);
			...
			_resources.create_resource<shader>("shader", L"VertexShader.hlsl", "main", "vs_5_0", L"PixelShader.hlsl", "main", "ps_5_0");
		}
		...
		//system
		_scenes.create_render_system<pipeline>();
