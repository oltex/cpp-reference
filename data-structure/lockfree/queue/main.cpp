...
int main(void) noexcept {
	...
	HANDLE _handle0 = reinterpret_cast<HANDLE>(_beginthreadex(nullptr, 0, func_tls, (void*)&_lockfree_queue, 0, 0));
	HANDLE _handle1 = reinterpret_cast<HANDLE>(_beginthreadex(nullptr, 0, func_tls, (void*)&_lockfree_queue, 0, 0));
	HANDLE _handle2 = reinterpret_cast<HANDLE>(_beginthreadex(nullptr, 0, func_tls, (void*)&_lockfree_queue, 0, 0));
	HANDLE _handle3 = reinterpret_cast<HANDLE>(_beginthreadex(nullptr, 0, func_tls, (void*)&_lockfree_queue, 0, 0));
	HANDLE _handle4 = reinterpret_cast<HANDLE>(_beginthreadex(nullptr, 0, func_tls, (void*)&_lockfree_queue, 0, 0));
	system("pause");
