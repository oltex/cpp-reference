...
namespace library {
	...
	public:
		...
		inline auto accept(void) const noexcept -> library::pair<socket, socket_address_ipv4> {
			...
			return library::pair<socket, socket_address_ipv4>(socket(sock), socket_address);
		}
